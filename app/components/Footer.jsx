...
const Footer = () => {
    return (
        < div>
<footer
   className="relative z-10 bg-gray-800 dark:bg-gray-800 pt-4  text-white overflow-hidden"
   >
      ...
      <div className="flex flex-wrap justify-between -mx-4">
         ...
         <div className="w-full px-4 sm:w-1/3 lg:w-3/12">
            <div className="w-full mb-10">
               ...
               <p className="text-base text-body-color dark:text-dark-6 bg-blue-900 rounded px-2 py-1">
               <svg
                     ...
                     Lane no-01, Right Turn, Kapil Nagar street, Road, Wadgaon Sheri Rd, behind Water Tank, opp. Novotel, Pune, Maharashtra 411014
         ...
         <div className="w-full px-4 sm:w-1/3 lg:w-3/12">
            <div className="w-full mb-10">
               ...
               <ul className="">
                  <li className=" cursor-pointer py-1 my-2"><span className="bg-blue-900 px-2 py-1 rounded"><Link href="/carlist">Buy a Car</Link></span></li>
                  <li className=" cursor-pointer py-1 my-2"><span className="bg-blue-900 px-2 py-1 rounded"><Link href="/addcar1">Sell Your Car</Link></span></li>
                  <li className=" cursor-pointer py-1 my-2"><span className="bg-blue-900 px-2 py-1 rounded"><Link href="/contact">Contact Us</Link></span></li>
               </ul>
         ...
         <div className="w-full px-4 sm:w-1/3 lg:w-3/12">
            <div className="w-full mb-10">
               ...
               <div className="flex items-center mb-6">
                  <Link
                     href="https://www.instagram.com/carlay.in/" legacyBehavior
                     >
                     <a target="_blank"
                  ...
                  <Link
                     href="https://www.youtube.com/@CarLayIndia" legacyBehavior
                     >
                     <a target="_blank"
                     className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-white hover:border-primary hover:bg-primary border-stroke dark:border-dark-3 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                     >
