...
{/* <footer className="p-4 bg-gray-800 sm:p-6 dark:bg-gray-800">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="#" target="_blank" className="flex items-center">
                ...
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">CarLay</span>
            </a>
        </div>
                ...
                <ul>
                    <li className="mb-4">
                        <a href="#" target="_blank"
                            className="text-gray-600 hover:underline dark:text-gray-400">CarLay</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" target="_blank" className="hover:underline">CarLay™</a>. All Rights Reserved.
</span>
      ...
      <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            ...
            CarLay
                ...
                {/* <h1 className="text-xxl text-blue-900">CarLay</h1> */}
               {/* <a
