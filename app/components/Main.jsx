    ...
    return (
        <>
            <Row className="h-auto">
                <Col lg="6" md="6" sm="12">
                    <div class="da relative flex flex-row justify-center overflow-hidden my-14">
                        ...
                        <div class="group relative m-0 flex h-72 w-96 rounded-xl shadow-xl ring-gray-900/5 sm:mx-auto sm:max-w-lg">
                            <div class="z-10 h-full w-full overflow-hidden rounded-xl border border-gray-200 opacity-80 transition duration-300 ease-in-out group-hover:opacity-100 dark:border-gray-700 dark:opacity-70">
                                <img src="/images/buy.jpg" class="animate-fade-in block h-full w-full scale-100 transform object-cover object-center opacity-100 transition duration-300 group-hover:scale-110" alt="" />
                            </div>
                            ...
                            <Link href="/carlist">
                                <button className="btn btn-success">Buy A Car</button>{' '}
                            </Link>
                            </div>
                        </div>
                    </div>
