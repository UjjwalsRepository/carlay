...
//     alert("This page is only accessible with Admin rights, Please login as Admin first")
//     router.push('/login')
// }
        ...
        {userInfo.userType==='Admin'?(
                ...
                <div className="flex items-center justify-center">
                  <div className="flex rounded-full bg-[#c4d5ed] mt-2 px-2 w-full max-w-[600px]">
                    <button className="self-center flex p-1 cursor-pointer bg-[#c4d5ed]">
                      {" "}
                      <svg
                        width="30px"
                        height="30px"
                    ...
                    <button
                      type="submit"
                      className="relative p-2 bg-[#c4d5ed] rounded-full"
                    >
                      <svg
                        width="30px"
                        height="30px"
