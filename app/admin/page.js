...
<div className='flex items-center justify-center'>
    <div className="flex rounded-full bg-[#c4d5ed] mt-2 px-2 w-full max-w-[600px]">
        <button className="self-center flex p-1 cursor-pointer bg-[#c4d5ed]"> <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <button type="submit" className="relative p-2 bg-[#c4d5ed] rounded-full">
